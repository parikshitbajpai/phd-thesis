...
\section{Multiphysics Integration of Computational Thermodynamics}
	...
	\begin{figure}[htbp]
		...
		\caption[Oxygen vacancy concentration in \ce{UO2} fuel obtained by coupling {Thermochimica} with {Bison}.]{Oxygen vacancy concentration in \ce{UO2} fuel obtained by coupling {Thermochimica} with {Bison}  \cite{Poschmann:2019aa}.}
		\label{fig:ovac}
		\end{center}
	\end{figure}
