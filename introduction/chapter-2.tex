...
\section{Tasks}
    ...
    \begin{itemize}
        ...
        \item Develop the new equilibrium solver in C++ following \gls{moose} coding conventions. The code must meet the rigorous source code control, continuous integration and verification requirements of \gls{moose}. Though {\GEM} is not \glsxtrshort{nqa}-{1} certified, it must try to achieve same quality standards as \gls{moose} is \glsxtrshort{nqa}-{1} certified. See \nameref{chap:implementation}.
